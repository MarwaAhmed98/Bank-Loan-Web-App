...
class ApprovalForm(forms.Form):
    ...
    ApplicantIncome=forms.IntegerField(widget=forms.NumberInput(attrs = {'placeholder': 'Enter your monthly income'}))
    CoapplicantIncome=forms.IntegerField(widget=forms.NumberInput(attrs = {'placeholder': 'Enter your co-partner monthly income'}))
